        ...
        <FadeInSection>
          <div className="max-w-lg mx-auto text-center">
            ...
            <h2 className="font-dot text-xl md:text-3xl mb-6 md:mb-8">
              <span className="text-[#FF0000]">{t.referral.heading}</span>
            ...
            <div className="font-body text-sm md:text-lg leading-loose mb-5 text-gray-900">
              <p>{t.referral.bodyLine1}</p>
              <p>{t.referral.bodyLine2}</p>
              <p>
                {t.referral.bodyLine3Before}
                <span className="font-dot text-[#FF0000] text-xl md:text-2xl mx-1 font-bold">{t.referral.bodyLine3Highlight}</span>
                {t.referral.bodyLine3After}
              </p>
            </div>
            ...
            <div className="py-6 md:py-8">
              <p className="font-dot text-2xl md:text-3xl text-gray-500 price-strike mb-2">{t.referral.strikePrice}</p>
              <div className="flex items-center justify-center my-2">
                <span className="text-[#FF0000] text-5xl md:text-6xl font-dot font-bold">↓</span>
              </div>
              <p className="font-body text-sm text-gray-600 mb-1">{t.referral.firstMonthLabel}</p>
              <p className="font-dot text-[4rem] md:text-[5.5rem] text-[#FF0000] leading-none"
                style={{ textShadow: "3px 3px 0 rgba(0,0,0,0.1)" }}>
                {t.referral.firstMonthPrice}
                {t.referral.firstMonthUnit && (
                  <span className="text-3xl md:text-4xl">{t.referral.firstMonthUnit}</span>
                )}
              </p>
            </div>
          </div>
